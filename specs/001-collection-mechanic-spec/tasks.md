...
- [ ] T005a [P] Verify `lrcollectionmechanic.lrdevplugin/Info.lua` registers the entry point under both `LrLibraryMenuItems` and `LrExportMenuItems`; add the missing registration if either is absent (FR-014)
